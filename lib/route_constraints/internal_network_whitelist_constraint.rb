...
class InternalNetworkWhitelistConstraint
  ...
  def internal_ip_list
    @@internal_ip_list ||= HashWithIndifferentAccess.new YAML.load_file(Rails.root.join('lib', 'route_constraints', 'internal_network_whitelist_ip_list.yml'))
  end
